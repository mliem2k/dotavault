      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        >
          <div
            ...
            style={{
              aspectRatio: '16 / 9',
              boxShadow: '0 0 32px 8px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.04)',
            }}
          >
            <video
              key={name}
          ...
          <div
            className="flex items-center justify-center gap-1 px-2 py-2 overflow-x-auto relative z-10"
            style={{ marginTop: -32 }}
          >
            {entries.map((e, i) => (
              <button
        ...
        <div
          ...
          style={{
            ...
            maxHeight: rightMaxH ?? undefined,
            overflowY: rightMaxH ? 'auto' : undefined,
          }}
        >
          ...
          <div className="flex items-start gap-4 pb-4 border-b border-border">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[15px] leading-snug text-foreground font-dota">
          ...
          {(a?.behavior || a?.dmg_type || a?.bkbpierce != null || a?.dispellable != null) && (
            <div className="flex gap-x-4 py-4 border-b border-border">
              ...
              <div className="flex-1 flex flex-col gap-y-1">
                {a?.behavior && (
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-[14px] font-bold text-white font-dota">
            ...
            <div className="py-4 border-b border-border">
              {attribs.map((x, i) => (
                ...
                <div key={i} className="flex items-baseline gap-2 py-0.5">
                  ...
                  <span className="text-[15px] font-bold tabular-nums text-white font-dota">
                    {joinLv(x.value)}
                  </span>
                </div>
              ))}
