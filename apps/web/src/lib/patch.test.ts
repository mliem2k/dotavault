...
describe('currentPatchFromList', () => {
  test('picks the newest patch whose release date is on or before now', () => {
  ...
  test('picks the last patch when now is after every release date', () => {
  ...
  test('picks the first patch when now is before every release date', () => {
